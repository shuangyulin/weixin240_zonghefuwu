 ...
 */
@TableName("gongao_collection")
public class GongaoCollectionView extends GongaoCollectionEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 类型的值
		*/
		private String gongaoCollectionValue;
	...
	public GongaoCollectionView() {

	}

	public GongaoCollectionView(GongaoCollectionEntity gongaoCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, gongaoCollectionEntity);
			...
			* 获取： 类型的值
			*/
			public String getGongaoCollectionValue() {
				return gongaoCollectionValue;
			}
			/**
			* 设置： 类型的值
			*/
			public void setGongaoCollectionValue(String gongaoCollectionValue) {
				this.gongaoCollectionValue = gongaoCollectionValue;
			}

			...
			<view class="detail-content">
				<view class="price detail-list-item priceFavor"
					...
					<view :style='{"textAlign":"left","fontSize":"45upx","color":"black"}'>
						{{detail.xiaoyuanshiwuzhaolingName}}
					</view>
				</view>
				...
				<view class="detail-list-item"
					...
					<view class="text" :style='{"color":"#FE8010","textAlign":"center","fontSize":"24rpx"}'>
						{{detail.xiaoyuanshiwuzhaolingUuidNumber}}
					</view>
				</view>
				<view class="detail-list-item"
					:style='{"boxShadow":"0 0 4rpx 0 #006633 insta","margin":"0 60rpx 0 60rpx","borderColor":"rgba(218, 218, 218, 1)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"68rpx"}'>
				...
				<view class="detail-list-item"
					...
					<view class="lable"
						...
						拾遗时间：</view>
					<view class="text" :style='{"color":"#FE8010","textAlign":"center","fontSize":"24rpx"}'>
						{{detail.xiaoyuanshiwuzhaolingTime}}
					</view>
				</view>
				<view class="detail-list-item"
					:style='{"boxShadow":"0 0 4rpx 0 #006633 insta","margin":"0 60rpx 0 60rpx","borderColor":"rgba(218, 218, 218, 1)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"68rpx"}'>
					<view class="lable"
						...
						拾遗地址：</view>
					<view class="text" :style='{"color":"#FE8010","textAlign":"center","fontSize":"24rpx"}'>
						{{detail.xiaoyuanshiwuzhaolingDizhi}}
					</view>
				</view>
		...
		<view class="bottom-content cu-bar bg-white tabbar border shop">
			...
			<view style="text-align: right;">
					<button @tap="onUpdateXinxiTypes(detail)" style="margin-right: 10upx;min-width: 180upx;"
						...
						:style="{width:'auto',borderRadius:'40rpx',height:'80rpx',fontSize:'28rpx',color:'rgba(239, 239, 239, 1)',backgroundColor:btnColor[2],borderColor:btnColor[2]}">失物认领</button>
			</view>
		</view>
		</view>
	...
	export default {
		...
		methods: {
			...
			async init() {
				...
				// 主图
				this.swiperList = this.detail.xiaoyuanshiwuzhaolingPhoto ? this.detail.xiaoyuanshiwuzhaolingPhoto
					.split(",") : [];
			},

<template>
	<view class="uni-padding-wrap">
		...
		<view class="pl15 col3 header-title" style="padding: 0 12px;box-sizing: border-box;"
			:style='{"backgroundColor":"#F37335","borderColor":"#FE8010","color":"rgba(255, 255, 255, 1.0)","borderRadius":"30rpx 30rpx 0px 0px","borderWidth":"4rpx","fontSize":"32rpx","lineHeight":"72rpx","borderStyle":"solid  solid none solid"}'>
		...
		<view v-if='2 == 1 || 2 == 2' class="uni-product-list" :class="2 == 2 ? 'active' : ''"
			...
			<view @tap="onDetailTap('goods',product.id)" :style='{"borderRadius":"12rpx","backgroundColor":"#FE8010"}'
		...
		<view class="pl15 col3 header-title" style="padding: 0 12px;box-sizing: border-box;"
			...
			<view class="right-content" @tap="onPageTap('gongao')"
				:style="{fontSize:'32rpx',color:'rgba(255, 255, 255, 1.0)'}">
				查看更多
			</view>
		</view>
		<view class="list" :style='{"borderRadius":"0","backgroundColor":"#efefef"}'>
			<view :style='{"borderRadius":"8rpx","backgroundColor":"#fff"}' @tap="onDetailTap('gongao',product.id)"
				v-for="(product,index) in gongaoList" :key="index" class="listm flex flex-between">
				<view class="listmr">
					<view class="col3 f30 elip mb15"
						:style='{"fontSize":"28rpx","lineHeight":"56rpx","color":"#FE8010","textAlign":"left"}'>
						{{product.gongaoName}}</view>
				</view>
				<image :style='{"borderRadius":"2rpx","height":"180rpx"}' mode="aspectFill" class="listmpic"
					:src="product.gongaoPhoto?product.gongaoPhoto.split(',')[0]:''"></image>
			</view>
		</view>
		<view class="pl15 col3 header-title" style="padding: 0 12px;box-sizing: border-box;"
			:style='{"backgroundColor":"#F37335","borderColor":"#FE8010","color":"rgba(255, 255, 255, 1.0)","borderRadius":"30rpx 30rpx 0px 0px","borderWidth":"4rpx","fontSize":"32rpx","lineHeight":"72rpx","borderStyle":"solid  solid none solid"}'>
			...
			<view class="right-content" @tap="onPageTap('xiaoyuanshiwuzhaoling')"
				:style="{fontSize:'32rpx',color:'rgba(255, 255, 255, 1.0)'}">
				查看更多
			</view>
		</view>
		<view v-if='2 == 1 || 2 == 2' class="uni-product-list" :class="2 == 2 ? 'active' : ''"
			:style='{"borderRadius":0,"backgroundColor":"#efefef"}'>
			<view @tap="onDetailTap('xiaoyuanshiwuzhaoling',product.id)"
				:style='{"borderRadius":"12rpx","backgroundColor":"#FE8010"}' class="uni-product"
				v-for="(product,index) in xiaoyuanshiwuzhaolingList" :key="index">
				<view class="uni-product-title"
					:style='{"fontSize":"28rpx","lineHeight":"56rpx","color":"#fff","textAlign":"center"}'>
					{{product.xiaoyuanshiwuzhaolingName}}
				</view>
				<view class="image-view" :style='{"borderRadius":"20rpx","height":"320rpx"}'>
					<image mode="aspectFill" :style='{"borderRadius":"20rpx","height":"320rpx"}'
						class="uni-product-image"
						:src="product.xiaoyuanshiwuzhaolingPhoto?product.xiaoyuanshiwuzhaolingPhoto.split(',')[0]:''">
					</image>
				</view>
				<view class="uni-product-price"
					:style='{"fontSize":"24rpx","lineHeight":"48rpx","color":"#fff","textAlign":"center"}'>
					<text v-if="product.xiaoyuanshiwuzhaolingNewMoney">￥{{product.xiaoyuanshiwuzhaolingNewMoney}}</text>
				</view>
			</view>
		</view>
...
<script>
	...
	export default {
		...
		async onShow() {
			...
			let gongao = await this.$api.list('gongao', {
				page: 1,
				limit: 6,
			});
			this.gongaoList = gongao.data.list
